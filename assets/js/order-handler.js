...
const WHATSAPP_NUMBER = "447735092971"; 

// إعدادات Cloudinary
const CLOUDINARY_CLOUD_NAME = "ddoumoqfo";
const CLOUDINARY_UPLOAD_PRESET = "rst619";

// بيانات التسعير بالدولار (تم تطبيق خصم 20%)
const pricingData = {
    "5": { "فضية": 8, "ذهبية": 15.2, "ماسية": 24 },
    "10": { "فضية": 16.8, "ذهبية": 32.8, "ماسية": 48.8 },
    "15": { "فضية": 25.6, "ذهبية": 50.4, "ماسية": 79.2 },
    "20+": { "فضية": 1.51, "ذهبية": 3.11, "ماسية": 4.71 }
};
